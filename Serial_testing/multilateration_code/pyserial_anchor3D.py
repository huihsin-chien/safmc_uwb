...
def calculate_position(anchor_positions, ranges):
    """
    Calculate the 3D position using trilateration with least squares method.
    
    :param anchor_positions: List of tuples [(x, y, z), ...] of the anchor positions
    :param ranges: List of distances from each anchor to the target
    :return: Tuple (x, y, z) of the calculated position
    """
