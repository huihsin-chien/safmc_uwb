...
#ifndef MSG_FOLDER__MSG__DETAIL__RANGE__TRAITS_HPP_
#define MSG_FOLDER__MSG__DETAIL__RANGE__TRAITS_HPP_
...
inline void to_yaml(
  const msg_folder::msg::Range & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const msg_folder::msg::Range & msg)
{
  return msg_folder::msg::to_yaml(msg);
}

template<>
inline const char * data_type<msg_folder::msg::Range>()
{
  return "msg_folder::msg::Range";
}

template<>
inline const char * name<msg_folder::msg::Range>()
{
  return "msg_folder/msg/Range";
}

template<>
struct has_fixed_size<msg_folder::msg::Range>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<msg_folder::msg::Range>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<msg_folder::msg::Range>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // MSG_FOLDER__MSG__DETAIL__RANGE__TRAITS_HPP_
