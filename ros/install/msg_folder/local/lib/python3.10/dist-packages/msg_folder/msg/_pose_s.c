...
bool msg_folder__msg__pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg_folder.msg._pose.Pose", full_classname_dest, 25) == 0);
  }
  msg_folder__msg__Pose * ros_message = _ros_message;
  {  // pos
...
PyObject * msg_folder__msg__pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg_folder.msg._pose");
