...
#include "uwb_msgs/msg/detail/pose__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = uwb_msgs::msg::Pose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const uwb_msgs::msg::Pose *>(
    untyped_ros_message);
...
{
  return &uwb_msgs::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
