...
#include "agent_msgs/msg/detail/tag_position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const agent_msgs::msg::TagPosition & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  agent_msgs::msg::TagPosition & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = agent_msgs::msg::TagPosition;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const agent_msgs::msg::TagPosition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<agent_msgs::msg::TagPosition *>(
    untyped_ros_message);
...
{
  return &agent_msgs::msg::typesupport_fastrtps_cpp::_TagPosition__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, agent_msgs, msg, TagPosition)() {
  return &agent_msgs::msg::typesupport_fastrtps_cpp::_TagPosition__handle;
}
