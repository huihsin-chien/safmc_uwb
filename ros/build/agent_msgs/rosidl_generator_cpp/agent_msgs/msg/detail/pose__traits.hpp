...
#ifndef AGENT_MSGS__MSG__DETAIL__POSE__TRAITS_HPP_
#define AGENT_MSGS__MSG__DETAIL__POSE__TRAITS_HPP_
...
inline std::string to_yaml(const agent_msgs::msg::Pose & msg)
{
  return agent_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<agent_msgs::msg::Pose>()
{
  return "agent_msgs::msg::Pose";
}

template<>
inline const char * name<agent_msgs::msg::Pose>()
{
  return "agent_msgs/msg/Pose";
}

template<>
struct has_fixed_size<agent_msgs::msg::Pose>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<agent_msgs::msg::Pose>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<agent_msgs::msg::Pose>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // AGENT_MSGS__MSG__DETAIL__POSE__TRAITS_HPP_
