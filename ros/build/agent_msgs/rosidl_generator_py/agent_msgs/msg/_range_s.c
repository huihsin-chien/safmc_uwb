...
bool agent_msgs__msg__range__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("agent_msgs.msg._range.Range", full_classname_dest, 27) == 0);
  }
  agent_msgs__msg__Range * ros_message = _ros_message;
  {  // range
...
PyObject * agent_msgs__msg__range__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("agent_msgs.msg._range");
