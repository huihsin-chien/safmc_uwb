...
bool agent_msgs__msg__pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("agent_msgs.msg._pose.Pose", full_classname_dest, 25) == 0);
  }
  agent_msgs__msg__Pose * ros_message = _ros_message;
  {  // pos
...
PyObject * agent_msgs__msg__pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("agent_msgs.msg._pose");
