...
static const _UwbMsg_type_support_symbol_names_t _UwbMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msg_folder, msg, UwbMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, msg_folder, msg, UwbMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, msg_folder, msg, UwbMsg)() {
  return &::msg_folder::msg::rosidl_typesupport_c::UwbMsg_message_type_support_handle;
}
