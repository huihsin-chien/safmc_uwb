...
bool msg_folder__msg__range__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("msg_folder.msg._range.Range", full_classname_dest, 27) == 0);
  }
  msg_folder__msg__Range * ros_message = _ros_message;
  {  // range
...
PyObject * msg_folder__msg__range__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("msg_folder.msg._range");
