...
#include "msg_folder/msg/detail/range__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msg_folder::msg::Range;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msg_folder::msg::Range *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msg_folder::msg::Range *>(
    untyped_ros_message);
...
{
  return &msg_folder::msg::typesupport_fastrtps_cpp::_Range__handle;
}
