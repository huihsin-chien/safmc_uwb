...
#include "msg_folder/msg/detail/pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const msg_folder::msg::Pose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  msg_folder::msg::Pose & ros_message)
{
  // Member: pos
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msg_folder::msg::Pose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const msg_folder::msg::Pose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<msg_folder::msg::Pose *>(
    untyped_ros_message);
...
{
  return &msg_folder::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, msg_folder, msg, Pose)() {
  return &msg_folder::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
