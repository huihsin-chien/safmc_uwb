...
bool uwb_msgs__msg__pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("uwb_msgs.msg._pose.Pose", full_classname_dest, 23) == 0);
  }
  uwb_msgs__msg__Pose * ros_message = _ros_message;
  {  // pos
...
PyObject * uwb_msgs__msg__pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("uwb_msgs.msg._pose");
